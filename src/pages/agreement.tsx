      ...
      <div className="grid grid-rows-2 lg:grid-cols-2 lg:grid-rows-none">
        <div>
          ...
          <p className="p-3 text-2xl lg:text-base">
            ...
            will also be for a term one for year and the agreement shall
            automatically renews on an annual basis. The merchant has the right
            to cancel their renewal at any time prior to the renewal date.
          </p>
        </div>
        <div>
          ...
          <p className="p-3 text-2xl lg:text-base">
            ...
            application. The tablet remains the property of Farely and shall be
            returned in the event of a termination of service. Failure to return
            the hardware in working condition will result in a fee of $120.00
            USD.
          </p>
        </div>
      </div>
